# Generated by Django 5.2.4 on 2025-09-01 17:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('present', 'Present'), ('late', 'Late'), ('absent', 'Absent')], default='SCAN', max_length=10)),
                ...
                ('tag', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='records', to='main_app.rfidtag')),
            ],
            options={
                'ordering': ['-scanned_at'],
            },
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['uid', 'scanned_at'], name='main_app_at_uid_455ef6_idx'),
        ),
    ]
