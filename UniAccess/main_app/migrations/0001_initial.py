# Generated by Django 5.2.4 on 2025-09-10 17:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college', models.CharField(choices=[('arts_science', 'College of Arts & Science'), ('business_finance', 'College of Business & Finance'), ('engineering', 'College of Engineering'), ('it', 'College of Information Technology'), ('medical_health', 'College of Medical & Health Sciences'), ('admin', 'Administration')], max_length=100)),
                ('custom_id', models.CharField(db_index=True, max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.PositiveIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='SCAN', max_length=10)),
                ('success', models.BooleanField(default=False)),
                ('note', models.TextField(blank=True, null=True)),
                ('extra', models.JSONField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rfid_scans', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scans', models.ManyToManyField(blank=True, related_name='attendance_links', to='main_app.rfidscan')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('assigned_to', models.OneToOneField(blank=True, db_column='assigned_to_custom_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rfid_tag', to=settings.AUTH_USER_MODEL, to_field='custom_id')),
            ],
        ),
        migrations.AddField(
            model_name='rfidscan',
            name='tag',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rfid_scans', to='main_app.rfidtag'),
        ),
        ...
        migrations.AddConstraint(
            model_name='courseinfo',
            constraint=models.UniqueConstraint(fields=('course', 'year', 'semester', 'section'), name='unique_section_per_term_teacher'),
        ),
        migrations.AddConstraint(
